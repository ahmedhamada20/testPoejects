...
class BestSellerController extends Controller
{
    ...
    {
        $this->middleware('permission:show-bestSeller', ['only' => 'index', 'show']);
        $this->middleware('permission:create-bestSeller', ['only' => 'create', 'store']);
        $this->middleware('permission:edit-bestSeller', ['only' => 'edit', 'update']);
        $this->middleware('permission:deleted-bestSeller', ['only' => 'destroy']);
    }


    protected $data = [
        'folder' => 'admin.',
        'Models' => 'App\Models\BestSeller',
        'route' => 'bestSeller',
        'folderBlade' => 'bestSeller',
        'folderImage' => 'bestSeller',
        'fileName' => 'test'
    ];
    ...
    public function bestSeller_photo_remove_image(Request $request)
    {
        $photo = Photo::findorfail($request->photo_id);
        if (File::exists('admin/pictures/bestSeller/' . $request->data_id . '/' . $photo->Filename)) {
