...
class AboutUsController extends Controller
{
    ...
    public function aboutUs_remove_image(Request $request)
    {
        $photo = PDF::findorfail($request->photo_id);
        if (File::exists('admin/bdf/aboutUs/' . $request->data_id . '/' . $photo->Filename)) {
    ...
    public function aboutUs_photo_remove_image(Request $request)
    {
        $photo = Photo::findorfail($request->photo_id);
        if (File::exists('admin/pictures/aboutUs/' . $request->data_id . '/' . $photo->Filename)) {
