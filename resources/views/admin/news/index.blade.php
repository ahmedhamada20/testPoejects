...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto"> الاخبار</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/   الاخبار</span>
            </div>
        </div>
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="row">
                        <div class="col">
                            @can('create-news')
                                <a href="{{route('news.create')}}" class="btn btn-success">اضافه جديده</a>
                            @endcan
                        </div>
                    </div>
