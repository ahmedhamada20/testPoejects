...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto"> المدونات</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/   المدونات</span>
            </div>
        </div>
                ...
                <div class="card-header">
                    ...
                    <div class="row">
                        <div class="col">
                            @can('create-blog')
                            @endcan
                            <a href="{{route('blog.create')}}" class="btn btn-success">اضافه جديده</a>
                        </div>
                    </div>
                            ...
                            @forelse($data as $row)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @endif
                                        @can('edit-blog')
                                            <a href="{{route('blog.edit',$row->id)}}" class="btn btn-success btn-sm"><i
