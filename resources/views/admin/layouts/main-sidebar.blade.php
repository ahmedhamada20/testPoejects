...
<aside class="app-sidebar sidebar-scroll">
    ...
    <div class="main-sidemenu">
        ...
        <ul class="side-menu">
            @can('dashboard')
                <li class="side-item side-item-category">التقرير</li>
                <li class="slide">
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}">
                    ...
                    <span class="side-menu__label">الصفحه الرئسيه</span><i
                        class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
                    @can('list-event')
                        <li><a class="slide-item" href="{{ route('event.index') }}">السليدر</a></li>
                    @endcan
