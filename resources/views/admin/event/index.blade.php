            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="row">
                        <div class="col">
                            @can('create-event')
                                <a href="{{route('event.create')}}" class="btn btn-success">اضافه جديده</a>
                            @endcan
                        </div>
                    </div>
                            ...
                            @forelse($data as $row)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @endif
                                        @can('edit-event')
                                            <a href="{{route('event.edit',$row->id)}}" class="btn btn-success btn-sm"><i
